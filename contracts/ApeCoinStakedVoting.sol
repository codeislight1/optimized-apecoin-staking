...
import "./OptimizedApeCoinStaking.sol";
...
contract ApeCoinStakedVoting is Ownable {
    ...
    OptimizedApeCoinStaking apeCoinStaking;
    ...
    constructor(address _apeCoinStakingAddress) {
        require(
            _apeCoinStakingAddress != address(0),
            "staking address cannot be zero"
        );
        apeCoinStaking = OptimizedApeCoinStaking(_apeCoinStakingAddress);
    }
